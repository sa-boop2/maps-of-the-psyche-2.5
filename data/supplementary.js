...
window.PsycheData.resources = {
  byTopic: [
    { topic: 'Shadow Work', books: ['Owning Your Own Shadow — Robert Johnson', 'Meeting the Shadow — Zweig & Abrams', 'A Little Book on the Human Shadow — Robert Bly'], practices: ['Shadow journaling', 'Projection tracking', '3-2-1 shadow process (Ken Wilber)'], thinkers: ['Carl Jung', 'Robert Johnson', 'Connie Zweig'], papers: ['The Shadow in Analytical Psychology — Jungian Review'], media: ['This Jungian Life (Podcast)', 'Academy of Ideas: Shadow Work'], courses: ['Jung Platform: Shadow Integration Intensive'] },
    { topic: 'Dream Work', books: ['Inner Work — Robert Johnson', 'The Interpretation of Dreams — Freud', 'Where People Fly and Water Runs Uphill — Jeremy Taylor'], practices: ['Dream journaling', 'Active imagination', 'Amplification method'], thinkers: ['Carl Jung', 'Sigmund Freud', 'James Hillman'], papers: ['Dream Symbolism and Affect Regulation'], media: ['Speaking of Jung: Dream Episodes'], courses: ['Depth Psychology Alliance Dream Group'] },
    { topic: 'Mindfulness & Meditation', books: ['The Mind Illuminated — Culadasa', 'Wherever You Go There You Are — Jon Kabat-Zinn', 'Seeing That Frees — Rob Burbea'], practices: ['Vipassana', 'Zazen', 'Loving-kindness', 'Body scan'], thinkers: ['Thich Nhat Hanh', 'Jack Kornfield', 'Pema Chödrön'], papers: ['Mindfulness-Based Interventions: Meta-analysis'], media: ['Ten Percent Happier Podcast'], courses: ['Palouse MBSR (Free Course)'] },
    { topic: 'Trauma Healing', books: ['The Body Keeps the Score — Bessel van der Kolk', 'Waking the Tiger — Peter Levine', 'Complex PTSD: From Surviving to Thriving — Pete Walker'], practices: ['Somatic experiencing', 'EMDR', 'IFS', 'Polyvagal exercises'], thinkers: ['Bessel van der Kolk', 'Peter Levine', 'Gabor Maté'], papers: ['Polyvagal Theory and Clinical Practice'], media: ['The Trauma Therapist Podcast'], courses: ['IFS Online Circle', 'Somatic Experiencing Intro Track'] },
    { topic: 'Individuation', books: ['Man and His Symbols — Carl Jung', 'The Undiscovered Self — Carl Jung', 'Iron John — Robert Bly'], practices: ['Active imagination', 'Dream analysis', 'Creative expression', 'Therapy'], thinkers: ['Carl Jung', 'Marie-Louise von Franz', 'James Hillman'], papers: ['Individuation as Lifelong Process'], media: ['Jungianthology Podcast'], courses: ['Jungian Studies Certificate (Intro)'] },
    { topic: 'Cognitive Science', books: ['Thinking Fast and Slow — Daniel Kahneman', 'Predictably Irrational — Dan Ariely', 'Stumbling on Happiness — Daniel Gilbert'], practices: ['Decision journaling', 'Pre-mortem analysis', 'Calibration training'], thinkers: ['Daniel Kahneman', 'Amos Tversky', 'Herbert Simon'], papers: ['Dual Process Theory Revisited'], media: ['Hidden Brain'], courses: ['Coursera: Learning How to Learn'] },
    { topic: 'Eastern Philosophy', books: ['Tao Te Ching — Laozi', 'Dhammapada', 'Bhagavad Gita', 'The Book of Chuang Tzu'], practices: ['Meditation', 'Yoga', 'Qigong', 'Contemplative inquiry'], thinkers: ['Laozi', 'Buddha', 'Shankara', 'Ramana Maharshi'], papers: ['Comparative Nonduality Studies'], media: ['Be Here Now Network'], courses: ['Intro to Buddhism (Online Sangha)'] },
    { topic: 'Mystical Traditions', books: ['The Essential Rumi — Coleman Barks', 'The Dark Night of the Soul — St. John of the Cross', 'The Zohar', 'The Cloud of Unknowing'], practices: ['Contemplative prayer', 'Sufi dhikr', 'Kabbalistic meditation', 'Centering prayer'], thinkers: ['Rumi', 'Meister Eckhart', 'Ibn Arabi', 'Teresa of Ávila'], papers: ['Apophatic Mysticism Across Traditions'], media: ['Turning to the Mystics Podcast'], courses: ['Centering Prayer Foundations'] },
    { topic: 'Indigenous Wisdom', books: ['Sand Talk — Tyson Yunkaporta', 'Braiding Sweetgrass — Robin Wall Kimmerer', 'God Is Red — Vine Deloria Jr.'], practices: ['Land-based practices', 'Ceremony', 'Storytelling', 'Community building'], thinkers: ['Tyson Yunkaporta', 'Robin Wall Kimmerer', 'Vine Deloria Jr.'], papers: ['Relational Epistemologies in Indigenous Traditions'], media: ['For The Wild Podcast'], courses: ['Land Literacy Workshop'] },
    { topic: 'Developmental Psychology', books: ['Childhood and Society — Erik Erikson', 'In Over Our Heads — Robert Kegan', 'The Evolving Self — Robert Kegan'], practices: ['Stage assessment', 'Growth edge work', 'Mentoring relationships'], thinkers: ['Erik Erikson', 'Robert Kegan', 'Ken Wilber'], papers: ['Constructive Developmental Theory Overview'], media: ['The Stoa: Developmental Dialogues'], courses: ['Vertical Development Foundations'] }
  ]
};
