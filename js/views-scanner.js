// ============================================================
// VIEWS â€” Shadow Scanner (Interactive Self-Inquiry)
  ...
  const questions = [
    ...
    },
    {
      ...
      options: [
        ...
        { text: "Dissociate â€” tell myself none of this is real or important anyway.", result: { fw: "buddhist", layer: 2 } },
    ...
    container.innerHTML = `
      <div class="scanner-intro">
        ...
        <div class="scanner-description fade-in" style="animation-delay:0.3s">
          ...
          <p class="scanner-warning">âš ï¸ These questions are designed to reach beneath the surface. Answer with your first instinct, not your idealized self.</p>
        </div>
        ...
        <p class="scanner-privacy fade-in" style="animation-delay:0.9s">
          ðŸ”’ Your answers are processed locally and never stored or transmitted.
        </p>
      </div>
    `;
  ...
  function renderQuestion(container) {
    ...
    container.innerHTML = `
      <div class="scanner-question-view">
        ...
        <div class="question-card fade-in">
          <div class="question-icon">${q.icon || "ðŸ‘ï¸"}</div>
        ...
        <div class="answer-options">
          ${q.options.map((opt, i) => `
            <button class="answer-option fade-in" data-idx="${i}" style="animation-delay:${0.1 + i * 0.08}s">
              ...
              <span class="option-select">â†’</span>
            </button>
          `).join('')}
        </div>
    ...
    container.querySelectorAll('.answer-option').forEach(btn => {
      ...
      btn.addEventListener('mouseenter', () => {
        btn.querySelector('.option-select').textContent = 'â†’';
      });
    });
  }
  ...
  function processResults(container) {
    ...
    const advanceStage = () => {
      if (stageIdx > 0 && stages[stageIdx - 1]) {
        ...
        stages[stageIdx - 1].querySelector('.stage-icon').textContent = 'âœ“';
      }
    ...
    container.innerHTML = `
      <div class="scanner-result">
        ...
        <div class="result-note fade-in" style="animation-delay:0.5s">
          <p>ðŸ’¡ <em>This is a starting point for exploration, not a definitive diagnosis. 
